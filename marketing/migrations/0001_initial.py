    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', stdimage.models.StdImageField(blank=True, null=True, upload_to='images/marketing/banner')),
                ('link_url', models.CharField(blank=True, max_length=250, null=True)),
                ('banner_text', models.CharField(blank=True, max_length=120, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', stdimage.models.StdImageField(blank=True, null=True, upload_to='images/marketing/banner')),
                ('link_url', models.CharField(blank=True, max_length=250, null=True)),
                ('is_on_offer', models.CharField(max_length=120)),
