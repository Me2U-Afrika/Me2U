    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_option', models.CharField(choices=[('S', 'Stripe'), ('M', 'M-Pesa'), ('C', 'Cash On Delivery'), ('D', 'Debit Card'), ('P', 'Paypal')], max_length=2)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('meta_description', models.CharField(help_text='help sellers get your product easily. Give a simple short description about the page content you have added', max_length=255, verbose_name='Meta Description')),
